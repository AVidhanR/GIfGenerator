...
#
# # Define a list to store the filenames of the images
# exampleImages = [
...
# #  - 'team.gif': Output filename
# #  - exampleImages: List of images to be saved in the GIF
# #  - duration=500: Duration of each frame in milliseconds (controls speed)
# #  - loop=0: Number of times the GIF loops (0 for infinite)
# if choice == 1:
#     for bs in brawlStarsImages:
#         image = iio.imread(bs)
#         bsImages.append(image)
#     iio.imwrite('Generated Gifs/brawlStars.gif', bsImages, duration=500, loop=0)
#     print("check out the brawlStars.gif file - that's just created!")
# elif choice == 2:
#     for m in myImages:
#         image = iio.imread(m)
#         mImages.append(image)
#     iio.imwrite('Generated Gifs/mine😁.gif', mImages, duration=500, loop=0)
#     print("check out the mine😁.gif file - that's just created!")
# elif choice == 3:
#     for n in natureImages:
#         image = iio.imread(n)
#         nImages.append(image)
#     iio.imwrite('Generated Gifs/nature.gif', nImages, duration=500, loop=0)
#     print("check out the nature.gif file - that's just created!")
# else:
#     for filename in exampleImages:
#         image = iio.imread(filename)
#         exampleImages.append(image)
#     iio.imwrite('Generated Gifs/team.gif', eImages, duration=500, loop=0)
